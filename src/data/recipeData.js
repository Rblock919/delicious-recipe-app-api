...
const recipedata = [
  ...
  },
  {
    ...
    steps: [
      ...
      {
        name: 'Warm Tortillas',
        body: 'While beef cooks, wrap tortillas in a damp paper towel and microwave on high until warm, about 30 seconds.'
      },
      {
        name: 'Assemble and Serve',
        body: 'Divide beef mixture between tortillas. Spoon salsa and crema over. Sprinkle with remaining cilantro. Serve with lime wedges on the side for ' +
                'squeezing over.'
      }
    ],
    nutritionValues: {
